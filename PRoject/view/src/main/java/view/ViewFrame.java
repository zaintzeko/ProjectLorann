...
class ViewFrame extends JFrame implements KeyListener {
	...
	private void buildViewFrame(final IModel model) {
		...
		this.setContentPane(new ViewPanel(this, model.getLorannWorld().getMotionElements(), model.getLorannWorld().getLorann(), model.getLorannWorld().getElements(), model.getLorannWorld().getWidth()*32, model.getLorannWorld().getHeight()*32));
	...
	public void keyPressed(final KeyEvent e) {
		...
		this.controller.orderPerform(this.key.getHorizontalKey(), this.key.getVerticalKey());
	}
