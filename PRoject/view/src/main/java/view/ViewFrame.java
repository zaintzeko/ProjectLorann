...
class ViewFrame extends JFrame implements KeyListener {
	...
	private void buildViewFrame(final IModel model) {
		...
		this.setContentPane(new ViewPanel(this, model.getLorannWorld().getArrayForDisplay(), model.getLorannWorld().getMotionlessElements(), model.getLorannWorld().getWidth()*32, model.getLorannWorld().getHeight()*32));
